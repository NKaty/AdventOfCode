...
def evaluate(exp):
    return eval(re.sub(r'\d+', lambda m: f'NewRulesInt({m.group(0)})',
                       re.sub(r'[\*\+]', lambda m: '*' if m.group(0) == '+' else '+', exp))).v
...
if __name__ == "__main__":
    ...
    print(find_expressions_sum(math_expressions))  # 158183007916215
